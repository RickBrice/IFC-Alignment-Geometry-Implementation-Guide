...
## 10.1 Schema Conceptual Comparison
...
### 10.3.1 LandXML Horizontal Element Types
...
### 10.3.2 Direction from Geometry
...
### 10.3.3 Circular Curve (`<Curve>` → `CIRCULARARC`)
...
### 10.3.7 Unhandled Horizontal Element Types
...
### 10.3.1 LandXML Vertical Data Model
...
### 10.3.2 PVI-Based to Segment-Based Conversion
...
### 10.3.3 Symmetric Parabolic Arc (`<ParaCurve>` → `PARABOLICARC`)
...
### 10.3.4 Asymmetric Parabolic Arc (`<UnsymParaCurve>` → Two `PARABOLICARC` Segments)
...
### 10.3.5 Circular Vertical Curve (`<CircCurve>` → `CIRCULARARC`)
...
### 10.3.2 Mapping to `IfcAlignmentCant`
...
## 10.6 Stationing and Station Equations

### 10.3.1 Start Station
...
### 10.3.2 Station Equations (`<StaEquation>`)
...
## 10.8 Known Limitations and Unresolved Issues
