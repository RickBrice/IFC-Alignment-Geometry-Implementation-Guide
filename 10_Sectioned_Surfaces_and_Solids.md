...
The example file [`Superelevation.ifc`](examples/Superelevation.ifc) is a working IFC model of this configuration.
...
The example file [`IfcSectionedSurface_with_breaklines.ifc`](examples/IfcSectionedSurface_with_breaklines.ifc) is a working IFC model of this configuration.
