...
*Figure 7.1 Recommended approach to nesting alignment layouts and referents*

Figure 7.1 shows two `IfcRelNests`, one each for alignment layout and referent. Also note the `IfcRelPositions` relationship. The referent defines the stationing and positions the alignment. The case shown is for horizontal, vertical, and cant. Horizontal only and horizontal with vertical are similar.
...
![](images/image8.2.png)
*Figure 7.2 Example of IfcReferent informing on the position of an IfcAlignmentSegment key point*
