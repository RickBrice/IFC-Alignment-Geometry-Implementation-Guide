...
Since $x_0 = 0$, $y_0 = 0$, and $\theta_0 = 0$, $M_N = \mathbf{I}$.
...
$$M_{h} = M_{CSP} M_N M_{PC} = \mathbf{I}
\begin{bmatrix}
0.971788979 & -0.235852028 & 0 & 140.705309648 \\
0.235852028 & 0.971788979 & 0 & 22.529160405 \\
0 & 0 & 1 & 0 \\
...
$$M_{h} = M_{CSP}\ M_N\ M_{PC} = \mathbf{I} \, \mathbf{I}  
\begin{bmatrix}
0.986539 & -0.1635219 & 0 & 99.72593255 \\
0.1635219 & 0.986539 & 0 & 5.5100 \\
0 & 0 & 1 & 0 \\
...
| 3 | For clothoid curves, convert `SegmentStart` from arc-length to unit parameter before evaluating | Compute $u = s / \left|A\sqrt{\pi}\right|$ where $A$ is the clothoid constant; the Fresnel integrals are defined in terms of $u$, not $s$ |
