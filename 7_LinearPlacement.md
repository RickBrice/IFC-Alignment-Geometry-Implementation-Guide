...
* review the iso on linear placement to see if there is other important concepts to discuss. one could be milepost system compared to stationing. need to look up iso spec
